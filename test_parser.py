...
class parser_function_test(unittest.TestCase):
    ...
    def test_parse_date_with_timezone(self):
        ...
        self.assertEqual(exp_date, self.psr._parse_date(to_parse),
                'exp {} | found {}'.format(exp_date, self.psr._parse_date(to_parse)))
    ...
    def test_parse_name(self):
        ...
        self.assertEqual(exp_name, self.psr._parse_name(to_parse),
                'exp {} | found {}'.format(exp_name, self.psr._parse_name(to_parse)))
    ...
    def test_parse_subject(self):
        ...
        self.assertEqual(exp_subject, self.psr._parse_subject(to_parse),
                'exp {} | found {}'.format(exp_subject, self.psr._parse_subject(to_parse)))
    ...
    def test_parse_from(self):
        ...
        self.assertEqual(exp_adr, self.psr._parse_from(to_parse),
                'exp {} | found {}'.format(exp_adr, self.psr._parse_from(to_parse)))
